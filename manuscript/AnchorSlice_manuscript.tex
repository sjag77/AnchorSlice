...
Taken together, these contributions ask how far a static, model-free stage can go: how much of a contract can be removed while every labelled vulnerability keeps its evidence, what that removal is worth in tokens, cost and latency, and what happens to detection quality when the same detector is driven this way rather than in the usual one.
...
\begin{tabular}{@{}p{3.2cm} p{12.2cm} c c@{}}
\hline
