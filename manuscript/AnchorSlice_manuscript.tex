...
\hline
\multicolumn{8}{@{}p{16.5cm}@{}}{\scriptsize DIVE + counts reference positives; Detector + counts contracts the detector marked positive; FN counts false negatives. Change is the shift in label agreement in percentage points.} \\
\end{tabular}
\end{table*}
